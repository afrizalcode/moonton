    ...
    return (
        <div className="flex justify-between items-center cursor-pointer">
            ...
            <div className="flex items-center gap-4">
                <span className="text-purple-600 text-sm font-medium">Welcome, { name }</span>
                
                <div className="collapsible-dropdown flex flex-col gap-2 relative" onClick={triggerDropdown} >

                    <div
                        className="outline outline-2 outline-purple-600 p-[5px] rounded-full w-[60px] dropdown-button">
                        <img src="/images/avatar.png" className="rounded-full object-cover w-full" alt="" />
                    </div>

                    <div className="bg-purple-500 rounded-2xl text-white logged-hover font-medium flex flex-col gap-1 absolute z-[999] right-0 top-[80px] min-w-[180px] hidden overflow-hidden"
                        ref={dropdownTarget} >
